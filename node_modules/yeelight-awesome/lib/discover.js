...
var Discover = /** @class */ (function (_super) {
     ...
     */
    Discover.prototype.scanByIp = function (startIp, endIp) {
        if (startIp === void 0) { startIp = 1; }
        if (endIp === void 0) { endIp = 254; }
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (this.devices.length === 0) {
                            return [2 /*return*/, Promise.reject("No device found after all ip scanned")];
                        }
                        return [2 /*return*/, Promise.resolve(this.devices)];
                }
            });
        });
    };
    ...
    Discover.prototype.start = function () {
        var _this = this;
        var localIp = ip_1.address();
        var me = this;
        return new Promise(function (resolve, reject) {
            _this.logger.debug("discover options: ", _this.options);
            _this.client.bind(_this.options.port, null, function () {
                me.client.setBroadcast(true);
                me.client.send(me.getMessage(), me.options.port, me.options.multicastHost, function (err) {
                    if (err) {
                        ...
                        me.timer = setInterval(function () {
                            ts_1 += interval_1;
                            if (_this.devices.length >= _this.options.limit) {
                            ...
                            if (_this.options.timeout > 0 && _this.options.timeout < ts_1) {
                                if (_this.devices.length > 0) {
                                    ...
                                    if (!_this.options.fallback) {
                                        reject("No device found after timeout exceeded : " + ts_1);
                                    }
                                }
                            }
                            ...
                            if (ts_1 > _this.options.timeout && _this.options.fallback) {
                                _this.scanByIp().then(resolve)["catch"](reject);
                            }
                        }, interval_1);
                    }
                });
    ...
    Discover.prototype.addDevice = function (device) {
        var existDevice = this.devices.findIndex(function (x) { return x.id === device.id; });
        if (existDevice <= 0) {
